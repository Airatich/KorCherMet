...
def clicks_for_metal_combine():
    # time.sleep(1)
    driver.find_element(By.XPATH,'/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table/tbody/tr[1]/td[2]/select/option[2]').click()

    driver.find_element(By.XPATH,'/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[1]/tbody/tr[3]/td[2]/input[2]').click()  ## показать
    driver.find_element(By.XPATH,"/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[2]/tbody/tr[15]/td[5]/input").click()
...
def clicks_for_metal_plant():
    # time.sleep(1)
    driver.find_element(By.XPATH,"/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[1]/tbody/tr[1]/td[2]/select/option[3]").click()  # отрасль предприятия - металлургический завод
    driver.find_element(By.XPATH,'/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[1]/tbody/tr[3]/td[2]/input[2]').click()  # показать
    driver.find_element(By.XPATH,"/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[2]/tbody/tr[61]/td[5]/input").click()
    driver.find_element(By.XPATH,"/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[2]/tbody/tr[62]/td[2]/input[1]").click()


def clicks_for_pipe_companies():
    driver.find_element(By.XPATH,"/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[1]/tbody/tr[1]/td[2]/select/option[5]").click() # отрасль предприятия - трубные предприятия
    driver.find_element(By.XPATH,'/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[1]/tbody/tr[3]/td[2]/input[2]').click() # показать
    selected=[3,6,7,9,11]
    for i in selected:
        element=driver.find_element(By.XPATH,f"/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[2]/tbody/tr[{str(i)}]/td[6]/input").click()
    driver.find_element(By.XPATH,'/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/table[2]/tbody/tr[64]/td[2]/input[1]').click() # выбрать
...
def clicks_for_steel():
    ...
    driver.find_element(By.XPATH,
                        "/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/form/table/tbody/tr[1]/td[2]/select/option[5]").click() # выбрать продукцию - сталь
    driver.find_element(By.XPATH,
                        "/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/form/table/tbody/tr[3]/td[2]/input[2]").click() # показать
    selected=[3,4,5,6]
...
#
    driver.find_element(By.XPATH,
                        "/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[4]/td/form/table[2]/tbody/tr[19]/td[2]/input").click()  ## Выбрать
    driver.find_element(By.XPATH, '/html/body/table/tbody/tr[5]/td/table[2]/tbody/tr[2]/td/table/tbody/tr/td/a').click() ## Вернуться к форме запроса
...
def to_excel(month_inp,year):
    try:
        ...
        data = data[0]
        data.to_excel(f'Сталь {month_inp.zfill(2)}.{year}.xlsx', index=False)
        table = pd.read_excel(f'Сталь {month_inp.zfill(2)}.{year}.xlsx', sheet_name='Sheet1', header=0, skiprows=17)
        table.dropna(axis=0, how="all", inplace=True)
        table.drop(table.index[[80, 81, 82]], axis=0, inplace=True)
        table.drop(table.columns[[0]], axis=1, inplace=True)

        table.to_excel(f'Сталь {month_inp.zfill(2)}.{year}.xlsx', index=False)
        print(f"Твой файл: Сталь {month_inp.zfill(2)}.{year}.xlsx")
